...
import twStuff.blocks.BlockBushTw;
...
public class twStuff
implements IFuelHandler
{
	public static WorldGenTw worldGen = new WorldGenTw();
	
    // The instance of your mod that Forge uses.
	@Instance("twStuff")
	public static twStuff instance;
	...
	public int getBurnTime(ItemStack fuel) {
		...
		if (fuel.itemID == BlockTw.darkwoodSapling.blockID)
			return 100;
		else if (fuel.itemID == ItemTw.darkwoodSticks.shiftedIndex)
			return 100;
		else
			return 0;
	}
